...
class RingSettingsDiamondsDetails extends Component {
    constructor(props) {
        super(props);
        this.state = {
            showFilter: true,
    ...
    addDiamond = () => {
        const data = {
            ...
            name: `${this.state.productdetails?.weight} Carat ${this.state.productdetails?.shape} ${this.state.productdetails?.type == "1" ? ' Cut Natural Diamond' : ' Cut Lab Diamond'}`,
        ...
        localStorage.setItem("bw-diamonddata", JSON.stringify(data));
        if (JSON.parse(localStorage.getItem("bw-settingdata")) == null) {
            this.props.history.push('/ringsettings');
        } else {
                        ...
                        <Row>
                            <Col className="rcs_breadcrumb mb-2">
                                <Breadcrumbs aria-label="breadcrumb">
                                    ...
                                    <NavLink underline="hover" color="inherit" to={this.state.productdetails?.type == "1" ? "/diamonds" : "/diamonds/lab"}>
                                        Diamonds
                                    </NavLink>
                                    ...
                                    {this.state.loader ?
                                        ...
                                        <div className="rcs_content_block w-100">
                                            <div className="rcs_product_heading">
                                                <h1>{this.state.productdetails?.weight} Carat {this.state.productdetails?.shape} {this.state.productdetails?.type == "1" ? ' Cut Natural Diamond' : ' Cut Lab Diamond'}</h1>
                                            </div>
                                            ...
                                            <div className="rcs_product_btn">
                                                ...
                                                }{this.state.productdetails?.is_cart || JSON.parse(localStorage.getItem('bw-diamonddata')) ?
...
export default RingSettingsDiamondsDetails;