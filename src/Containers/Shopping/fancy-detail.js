...
class Fancycolordetail extends Component {
    constructor(props) {
        super(props);
        this.state = {
            showFilter: true,
    ...
    addDiamond = () => {
        const data = {
            ...
            name: `${this.state.productdetails?.weight} Carat ${this.state.productdetails?.shape} ${this.state.productdetails?.type == "1" ? ' Cut Natural Diamond' : this.state.productdetails?.type == "2" ? ' Cut Lab Diamond' : this.state.productdetails?.type == "4" ? ' Cut Fancy Diamond' : " Cut Diamond"}`,
            clarity: this.state.productdetails?.clarity,
        ...
        localStorage.setItem("bw-fancycolordata", JSON.stringify(data));
        if (JSON.parse(localStorage.getItem("bw-settingdata")) == null) {
            this.props.history.push('/ringsettings/fancycolor');
        } else {
        ...
        return (
            <>
                        ...
                        <Row>
                            <Col className="rcs_breadcrumb mb-2">
                                <Breadcrumbs aria-label="breadcrumb">
                                    ...
                                    <NavLink underline="hover" color="inherit" to="/fancy-color-diamond">
                                        Fancy Color
                                    </NavLink>
                                    <Typography color="text.primary">
                                        {this.state.productdetails.shape}
                                    </Typography>
                                </Breadcrumbs>
                            </Col>
                        </Row>
                                    ...
                                    {this.state.loader ?
                                        ...
                                        <div className="rcs_content_block w-100">
                                            <div className="rcs_product_heading">
                                                <h1>{this.state.productdetails?.weight} Carat {this.state.productdetails?.shape}{this.state.productdetails?.type == "1" ? ' Cut Natural Diamond' : this.state.productdetails?.type == "2" ? ' Cut Lab Diamond' : this.state.productdetails?.type == "4" ? ' Cut Fancy Diamond' : " Cut Diamond"}</h1>
                                            </div>
                                            ...
                                            <div className="rcs_product_btn">
                                                {this.state.productdetails?.is_cart ?
                                                    ...
                                                    :
                                                    <Button variant="contained" onClick={this.addDiamond} className="rcs_acc_button rcs_acc_button1 w-100 mb-3">Add This Diamond</Button>
                                                }{this.state.productdetails?.is_cart || JSON.parse(localStorage.getItem('bw-fancycolordata')) ?
                        ...
                        <Row className="m-auto w-100">
                            <Col className="p-0 mb-5">
                                ...
                                <Row>
                                   ...
                                   {this.state.productdetails?.fancy_color_intensity && <Col xs={6} sm={3}>
                                        <div className="rcs_product_specification_content">
                                            <strong>Intensity  : </strong>
                                            <p>{this.state.productdetails?.fancy_color_intensity}</p>
                                        </div>
                                    </Col>}
                                   ...
                                   {this.state.productdetails?.lab && <Col xs={6} sm={3}>
                                        <div className="rcs_product_specification_content">
                                            <strong>Lab  : </strong>
                                            <p>{this.state.productdetails?.lab}</p>
                                        </div>
                                    </Col>}
                                   {this.state.productdetails?.polish && <Col xs={6} sm={3}>
                                        <div className="rcs_product_specification_content">
                                            <strong>Polish  : </strong>
                                            <p>{this.state.productdetails?.polish}</p>
                                        </div>
                                    </Col>}
                                   {this.state.productdetails?.symmetry && <Col xs={6} sm={3}>
                                        <div className="rcs_product_specification_content">
                                            <strong>Symmetry  : </strong>
                                            <p>{this.state.productdetails?.symmetry}</p>
                                        </div>
                                    </Col>}
                                   {this.state.productdetails?.fluorescence_intensity && <Col xs={6} sm={3}>
                                        <div className="rcs_product_specification_content">
                                            <strong>Fluorescence  : </strong>
                                            <p>{this.state.productdetails?.fluorescence_intensity}</p>
                                        </div>
                                    </Col>}
                                   {this.state.productdetails?.depth && <Col xs={6} sm={3}>
                                        <div className="rcs_product_specification_content">
                                            <strong>Depth %  : </strong>
                                            <p>{this.state.productdetails?.depth}</p>
                                        </div>
                                    </Col>}
                                   {this.state.productdetails?.table_per && <Col xs={6} sm={3}>
                                        <div className="rcs_product_specification_content">
                                            <strong>Table %  : </strong>
                                            <p>{this.state.productdetails?.table_per}</p>
                                        </div>
                                    </Col>}
                                   ...
                                   {this.state.productdetails?.girdle_min && <Col xs={6} sm={3}>
                                        <div className="rcs_product_specification_content">
                                            <strong>Girdle Minimum  : </strong>
                                            <p>{this.state.productdetails?.girdle_min}</p>
                                        </div>
                                    </Col>}
                                   {this.state.productdetails?.girdle_max && <Col xs={6} sm={3}>
                                        <div className="rcs_product_specification_content">
                                            <strong>Girdle Maximum  : </strong>
                                            <p>{this.state.productdetails?.girdle_max}</p>
                                        </div>
                                    </Col>}
                                   {this.state.productdetails?.culet_size && <Col xs={6} sm={3}>
                                        <div className="rcs_product_specification_content">
                                            <strong>Culet  : </strong>
                                            <p>{this.state.productdetails?.culet_size}</p>
                                        </div>
                                    </Col>}
                                   {this.state.productdetails?.crown_height && <Col xs={6} sm={3}>
                                        <div className="rcs_product_specification_content">
                                            <strong>Crown Height  : </strong>
                                            <p>{this.state.productdetails?.crown_height}</p>
                                        </div>
                                    </Col>}
                                   {this.state.productdetails?.crown_angle && <Col xs={6} sm={3}>
                                        <div className="rcs_product_specification_content">
                                            <strong>Crown Angle  : </strong>
                                            <p>{this.state.productdetails?.crown_angle}</p>
                                        </div>
                                    </Col>}
                ...
                {this.state.appointment ?
                    <ProductAppoitnment type="diamond" id={this.state.productdetails?.stock_no} handleClose={() => this.setState({ appointment: false })} /> : ""
                }
                {/*Appointment Modal*/}
                {/*Return Modal*/}
                {this.state.return ?
...
export default Fancycolordetail;